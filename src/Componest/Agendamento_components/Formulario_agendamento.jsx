...
import "./Formulario_agendamento.css";
...
const FormularioAgendamento = () => {
  ...
  const formValido = () => {
    ...
    if (!formData.dia) {
      ...
      errors.dia =
        "A data não pode ser anterior ao dia atual, tente novamente!";
      valido = false;
    ...
    if (!formData.horaInicio) {
      ...
      errors.horaInicio =
        "O horário de início deve ser superior ao horário atual!";
      valido = false;
    }
    ...
    if (
      ...
      errors.quantidadePessoas =
        "Por favor, informe a quantidade de pessoas maior que zero!";
      valido = false;
    }
  ...
  return (
    <div className="formulario-container">
      ...
      <h4 className="subTitle01">
        AGENDAMENTO é uma página direcionada para selecionar datas para
        utilização do laboratório, horários de início ao fim, quantidades de
        pessoas e calendário ilustrativo.
      </h4>
      <form onSubmit={handleSubmit} className="formulario">
        ...
        <div className="horarios">
          <div className="horario">
            ...
            {formErrors.horaInicio && (
              <p className="error">{formErrors.horaInicio}</p>
            )}
          </div>
          <div className="horario">
            <label>
            ...
            {formErrors.horaFim && (
              <p className="error">{formErrors.horaFim}</p>
            )}
          </div>
        </div>
        <br />
        ...
        {formErrors.quantidadePessoas && (
          <p className="error">{formErrors.quantidadePessoas}</p>
        )}
        <br />
        <div className="sessao_btn">
          <button className="Button_agendamento" type="submit">
            Enviar
          </button>
        </div>
      </form>
