  ...
  return (
    <BoxEquipametos>
      <TextoEquipamentos>
        ...
        <DescricaoEquipamento>
          EQUIPAMENTOS é uma página direcionada aos equipamentos encontrados no
          laboratório, além de descrever sua funcionalidade e quais estão
          disponiveis.
        </DescricaoEquipamento>
      </TextoEquipamentos>
      <BoxTrioEquipamentos>
        <CardEquipamento>
          ...
          <FuncaoEquipamento>
            Utilizado para aquecer e agitar soluções químicas, usando um
            peixinho magnético no recipiente.
          </FuncaoEquipamento>
        ...
        <CardEquipamento>
          ...
          <FuncaoEquipamento>
            Utilizada para a esterilização de materiais através de calor e
            pressão por um determinado período.
          </FuncaoEquipamento>
          <DisponibilidadeEquipamento>DISPONIVEL: 2</DisponibilidadeEquipamento>
        </CardEquipamento>
        <CardEquipamento>
          ...
          <FuncaoEquipamento>
            Utilizada para medição de massas com alta precisão, geralmente
            miligramas ou menos.
          </FuncaoEquipamento>
          <DisponibilidadeEquipamento>DISPONIVEL: 2</DisponibilidadeEquipamento>
        </CardEquipamento>
      ...
      <BoxTrioEquipamentos>
        <CardEquipamento>
          ...
          <FuncaoEquipamento>
            Utilizada para medição de amostras pequenas e determina o peso do
            material de maneira rápida e simples.
          </FuncaoEquipamento>
        ...
        <CardEquipamento>
          ...
          <FuncaoEquipamento>
            Utilizado para preparar soluções e diluições que necessitam de
            medidas extremamente precisas.
          </FuncaoEquipamento>
          <DisponibilidadeEquipamento>
            DISPONIVEL: 20
          </DisponibilidadeEquipamento>
        ...
        <CardEquipamento>
          ...
          <FuncaoEquipamento>
            Utilizada para agitar soluções junto ao equipamento de agitação
            magnética.
          </FuncaoEquipamento>
          <DisponibilidadeEquipamento>DISPONIVEL: 2</DisponibilidadeEquipamento>
        </CardEquipamento>
      ...
      <BoxTrioEquipamentos>
        <CardEquipamento>
          ...
          <FuncaoEquipamento>
            Utilizado para agitar soluções e direcionar um líquido na
        ...
        <CardEquipamento>
          ...
          <FuncaoEquipamento>
            Utilizado para medição de volumes e na realização de misturas em
            experimentos.
          </FuncaoEquipamento>
          <DisponibilidadeEquipamento>
            DISPONIVEL: 40
        ...
        <CardEquipamento>
          ...
          <FuncaoEquipamento>
            Utilizado no processo de filtração de misturas e na transferência de
            recipientes, evitando perdas
          </FuncaoEquipamento>
          <DisponibilidadeEquipamento>
            DISPONIVEL: 20
          </DisponibilidadeEquipamento>
      ...
      <BoxTrioEquipamentos>
        <CardEquipamento>
          ...
          <FuncaoEquipamento>
            Utilizado para ampliar amostras para que possam ser observadas com
            mais detalhes.
          </FuncaoEquipamento>
          <DisponibilidadeEquipamento>DISPONIVEL: 2</DisponibilidadeEquipamento>
        </CardEquipamento>
        <CardEquipamento>
          ...
          <FuncaoEquipamento>
            Utilizada para cultivar e observar o comportamento ou secagem de
            amostras.
          </FuncaoEquipamento>
          <DisponibilidadeEquipamento>
            DISPONIVEL: 30
        ...
        <CardEquipamento>
          ...
          <FuncaoEquipamento>
            Utilizada para medição e transferência de volumes de líquidos ou
            soluções.
          </FuncaoEquipamento>
          <DisponibilidadeEquipamento>
            DISPONIVEL: 15
      ...
      <BoxTrioEquipamentos>
        <CardEquipamento>
          ...
          <FuncaoEquipamento>
            Utilizado para alocar soluções e reagentes, como a água destilada ou
            deionizada, entre outros.
          </FuncaoEquipamento>
        ...
        <CardEquipamento>
          ...
          <FuncaoEquipamento>
            Utilizado para coletar amostras para análise laboratorial.
          </FuncaoEquipamento>
        ...
        <CardEquipamento>
          ...
          <FuncaoEquipamento>
            Utilizados para realizar reações químicas em pequenas quantidades.
          </FuncaoEquipamento>
          <DisponibilidadeEquipamento>
            DISPONIVEL: 10
          </DisponibilidadeEquipamento>
